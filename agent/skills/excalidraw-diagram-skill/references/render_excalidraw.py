...
def render(
    ...
    with sync_playwright() as p:
        # ponytail: try system chrome first, fall back to playwright-managed
        import shutil
        ...
        if chrome_path:
            ...
            try:
                ...
                print("ERROR: No browser available. Install google-chrome or run: playwright install chromium", file=sys.stderr)
                sys.exit(1)
