# ADHD Output — Project Integration

Add this to your project's `AGENTS.md` to enable ADHD-friendly output by default:
...
```
/adhd-output              → enable for this session
/stop adhd mode           → disable
```
